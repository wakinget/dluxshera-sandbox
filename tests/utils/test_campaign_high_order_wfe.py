...
def test_mirror_specific_primary_ke_preserves_secondary_truth_match() -> None:
    ...
    assert result.provenance["primary"]["truth_inference_difference_rms_nm"] == pytest.approx(0.1)
...
def test_mirror_specific_secondary_ke_preserves_primary_truth_match() -> None:
    ...
    assert result.provenance["secondary"]["truth_inference_difference_rms_nm"] == pytest.approx(0.1)
