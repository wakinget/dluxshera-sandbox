...
def test_hpc_sbatch_templates_are_parameterized() -> None:
    for name, default_workers in (
        ("full_fidelity_registration_solve_smoke_hpc.sbatch", 'MAX_WORKERS="${MAX_WORKERS:-1}"'),
        ("full_fidelity_zernike_2x2_self_correction_hpc.sbatch", 'MAX_WORKERS="${MAX_WORKERS:-4}"'),
    ):
