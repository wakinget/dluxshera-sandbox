...
Source config: `examples/recipes/full_fidelity_howfe_field_dither_20260720/configs/production/ff_howfe_field_m1_hoke_0p01nm_xp0p0_yp0p0_w10x30_v1.yaml`

This directory contains 100 `draw` shards. The original 300-subblock
