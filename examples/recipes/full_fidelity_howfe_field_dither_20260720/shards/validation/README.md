...
Source config: `examples/recipes/full_fidelity_howfe_field_dither_20260720/configs/validation/ff_howfe_field_noke_xp0p0_yp0p0_w1x30_v1.yaml`

This directory contains 8 `draw` shards. The original 300-subblock
