...
## Choose your path
- **Canonical three-plane demo:** Start with `Examples/scripts/run_canonical_astrometry_demo.py` and the walkthrough in [docs/tutorials/canonical_astrometry_demo.md](tutorials/canonical_astrometry_demo.md). This exercises the full refactor-era stack on a Shera-like three-plane system.
