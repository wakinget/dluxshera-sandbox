...
- unknown top-level system component keys: emitted as warnings and kept in the resolved config; experiment extras remain permissive for recipe-level validation
