...
Source config: `examples/recipes/full_fidelity_next_campaigns_20260703/full_fidelity_info_damped_hoke_1p0nm_loz0p01nm_n10_w10x30_projected_30min_v1.yaml`

This directory contains 10 `draw` shards. The original 300-subblock
...
Recommended resources are `4-00:00:00`, 16 CPUs,
`250G`, and `MAX_WORKERS=10`. Preflight uses
