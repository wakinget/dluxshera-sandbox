...
This directory contains 10 draw-mode shards for `61_CYG` in the target-registry No-KE hard-low-order campaign. Each shard is one prior draw and expects 10 windows x 30 subblocks/window = 300 subblocks.
