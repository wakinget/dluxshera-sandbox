...
CONFIG_FIELD_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "experiment.iterative.eigenbasis.damping_mode": _entry(valid_values=_values(("none", "implemented", "No eigen-coordinate damping."), ("scalar", "implemented", "Use one scalar damping factor for every mode."), ("information", "implemented", "Use lambda/(lambda+damping_value) damping.")), consumed_by="observation_bias update policy"),
