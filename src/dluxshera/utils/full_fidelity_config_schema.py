...
CONFIG_FIELD_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "experiment.subblocks.trajectory_processing.smear.render.mode": _entry(valid_values=_values(("disabled", "implemented", "Remove/disable the named smear layer and write no rendered smear."), ("none", "implemented", "Compatibility alias for no rendered smear."), ("metadata_only", "implemented", "Write smear sidecars; remove/disable the named smear render layer."), ("subblock_constant_layer", "implemented", "Patch a representative trajectory-derived line kernel into the named smear layer."), ("line_kernel_from_trajectory", "future_placeholder", "Future line kernel rendering."), ("per_frame_dynamic_kernel", "future_placeholder", "Future dynamic kernel rendering.")), consumed_by="trajectory_smear"),
