...
CONFIG_FIELD_REGISTRY: dict[str, dict[str, Any]] = {
    "experiment.kind": _entry(
        valid_values=_values(
            ("full_fidelity_binary_iterative_review", "implemented", "Executable resolved-system review schema translated to observation_bias_campaign."),
            ("full_fidelity_binary_iterative_smoke", "implemented", "Tiny wiring smoke schema translated to observation_bias_campaign."),
    ...
    "experiment.system_preset": _entry(valid_values=_values(("SHERA_FLIGHT_3P", "implemented", "Current flight three-plane preset."), ("SHERA_FLIGHT_2P", "implemented", "Two-plane flight preset."), ("SHERA_TESTBED_3P", "implemented", "Testbed three-plane preset.")), consumed_by="config resolver", fidelity_effect="base source/optics/detector stack"),
    ...
    "experiment.subblocks.trajectory_processing.smear.render.mode": _entry(valid_values=_values(("none", "implemented", "No smear sidecars/render layer."), ("metadata_only", "implemented", "Write smear sidecars; do not insert render layer."), ("subblock_constant_layer", "future_placeholder", "Future constant render layer."), ("line_kernel_from_trajectory", "future_placeholder", "Future line kernel rendering."), ("per_frame_dynamic_kernel", "future_placeholder", "Future dynamic kernel rendering.")), consumed_by="trajectory_smear"),
    ...
    "experiment.iterative.update_mode": _entry(valid_values=_values(("physical_full", "implemented", "Physical basis full update."), ("eigen_full", "future_placeholder", "Future eigenbasis update."), ("eigen_damped", "future_placeholder", "Future damped eigenbasis update."), ("eigen_truncated", "future_placeholder", "Future truncated eigenbasis update.")), consumed_by="observation_bias"),
...
for _path, _meta in {
    ...
    "experiment.subblocks.variance_floor": ("subblock runner", "variance model"),
